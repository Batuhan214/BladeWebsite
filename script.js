...
(function () {
  ...
  var EN = {
    ...
    // Pricing
    'pricing.eyebrow': 'Pricing', 'pricing.h2': 'Start free. Go Premium.',
    'pricing.sub': 'One Premium – all features. You just choose how to pay.',
    // Free
    'pricing.free': 'Free', 'pricing.freesub2': 'The complete subscription manager.',
    'pricing.pricefree': '€0', 'pricing.freesub': 'forever',
    'pricing.f1': 'Unlimited manual subscriptions & management',
    'pricing.f2': 'Overview & cost dashboard (monthly & yearly, categories, many currencies)',
    'pricing.f3': 'Cancellation & trial reminders (Trial Killer)',
    'pricing.f4': 'Cancel with direct links + 24-hour reactivation',
    'pricing.f5': 'Home & Lock Screen widgets & Apple Watch',
    'pricing.f6': 'Subscription recap (Story) & rewards / wheel of fortune',
    'pricing.f7': 'Connect 1 inbox',
    'pricing.f8': 'Savings potential: total amount visible',
    'pricing.f9': 'AI to try: 3 AI imports, 1 deep scan & 5 Inbox Slayer actions free',
    'pricing.freecta': 'Start for free',
    // Premium benefits (central)
    'pricing.premtitle': 'Blade Premium', 'pricing.premtag': 'One tier · 3 billing options',
    'pricing.premsub': 'All options include the same features – you only pick the term.',
    'pricing.p1': 'Everything in Free, plus:',
    'pricing.p2': 'Unlimited AI import (free text, email/photo, mail forwarding)',
    'pricing.p3': 'Unlimited AI deep scan + automatic daily scan',
    'pricing.p4': 'Add found subscriptions directly (Free only sees the count)',
    'pricing.p5': 'Price-increase alerts',
    'pricing.p6': 'Savings in detail: which subscriptions + cancel with one tap',
    'pricing.p7': 'Multiple inboxes at once',
    'pricing.p8': 'Inbox Slayer unlimited',
    'pricing.p9': 'Share household (family & flatshare)',
    'pricing.p10': 'No ads',
    // Billing variants
    'pricing.varmonth': 'Monthly', 'pricing.pricemonth': '€1.99', 'pricing.permonth': '/month',
    'pricing.monthsub': 'Flexible, cancel anytime.', 'pricing.monthcta': 'Get Monthly',
    'pricing.varyear': 'Yearly', 'pricing.priceyear': '€14.99', 'pricing.peryear': '/year',
    'pricing.yearmonthly': 'only €1.25 / month', 'pricing.yearsub': 'Save ~37% vs. monthly.',
    'pricing.yearcta': 'Get Yearly', 'pricing.popular': 'Popular', 'pricing.save37': '−37%',
    'pricing.varlife': 'Lifetime', 'pricing.pricelife': '€49.99', 'pricing.once': 'one-time',
    'pricing.lifesub': 'Pay once, Premium forever.', 'pricing.lifecta': 'Get Lifetime',
    'pricing.bestvalue': 'Best value',
    'pricing.note': 'Payment & management via the App Store, cancel anytime. Coming soon.',
    // FAQ
